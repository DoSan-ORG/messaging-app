  ...
  return (
    <div>
      <div className="card-footer d-sm-flex w-100 border-0 pt-3 pb-3 px-4">
        <form onSubmit={(event) => sendMessage(event)} className=" position-relative w-100 me-2 mb-3 mb-sm-0">
          <input
            id="messageInput"
            onChange={(e) => setMessage(e.target.value)}
            value={message} name="messageInput"
            type="text"
          ...
          <div className="position-absolute top-50 end-0 translate-middle-y d-flex zindex-3 me-2">
            <button type="button" className="btn btn-icon btn-sm btn-link nav-link bg-faded-primary-hover me-1">
